...
const getPatientProfessionalAvailabilitySchema = z.object({
  professionalId: z.string().min(1, "ID do profissional é obrigatório"),
});

export const getPatientProfessionalAvailability = actionClient
  .schema(getPatientProfessionalAvailabilitySchema)
  .action(async ({ parsedInput }) => {
    ...
    // Buscar dados do profissional na mesma clínica do paciente
